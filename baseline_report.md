...
**Notable Finding:**  
The feature audit in baseline.ipynb explicitly classified all columns by pre/post-race availability. This forced explicit thinking about leakage risk before building features. Lesson: audit features _before_ using them.
